...
export const WalletIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      clipRule="evenodd"
      d="M0 3.5C0 2.11929 1.11929 1 2.5 1H11.5C12.8807 1 14 2.11929 14 3.5V4H14.5C15.3284 4 16 4.67157 16 5.5V10.5C16 11.3284 15.3284 12 14.5 12H14V12.5C14 13.8807 12.8807 15 11.5 15H2.5C1.11929 15 0 13.8807 0 12.5V3.5ZM14 10.5H14.5V5.5H14V10.5ZM12.5 12V4H2.5C1.94772 4 1.5 3.55228 1.5 3V12.5C1.5 13.0523 1.94772 13.5 2.5 13.5H11.5C12.0523 13.5 12.5 13.0523 12.5 12.5V12ZM11.5 2.5H2.5C1.94772 2.5 1.5 2.94772 1.5 3.5C1.5 3.55228 1.94772 4 2.5 4H11.5C12.0523 4 12.5 3.55228 12.5 3V3.5C12.5 2.94772 12.0523 2.5 11.5 2.5ZM11.5 7.5C11.5 8.05228 11.9477 8.5 12.5 8.5C13.0523 8.5 13.5 8.05228 13.5 7.5C13.5 6.94772 13.0523 6.5 12.5 6.5C11.9477 6.5 11.5 6.94772 11.5 7.5Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
